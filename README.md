...
The **almmr** package provides tools for modeling movement,
accessibility, and territorial structure in archaeological landscapes.  
It builds on digital elevation models (DEMs) and implements cost-surface
